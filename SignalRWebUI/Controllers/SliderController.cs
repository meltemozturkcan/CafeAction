...
namespace SignalRWebUI.Controllers
{
    public class SliderController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responMessage = await client.GetAsync("https://localhost:7276/api/Slider");
        ...
        public async Task<IActionResult> CreateSlider(CreateSliderDto createSliderDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7276/api/Slider", strContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"https://localhost:7276/api/Slider/{id}");
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
            return View("hata_olustu");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"https://localhost:7276/api/Slider/{id}");
        ...
        public async Task<IActionResult> UpdateSlider(UpdateSliderDto updateSliderDto)
        {
            ...
            StringContent strContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            var responseMessage = await client.PutAsync("https://localhost:7276/api/Slider", strContent);
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
